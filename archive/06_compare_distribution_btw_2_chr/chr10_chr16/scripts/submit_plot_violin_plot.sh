...
# ---------------------------------------------------------------------
# Date: 12/31/2019
# Submit R script to plot and compute statistics between chr10 and chr16
# ---------------------------------------------------------------------
# macaque
...
Rscript /agavescratch/tphung3/Cayo_x_inactivation/compare_distribution_btw_2_chr/chr10_chr16/scripts/plot_violin_plot_chr10_chr16_Cayo_prephasing.R ${id} ${t}
