...
png("/scratch/tphung3/Cayo_x_inactivation/12_manuscript_plots/figure_3a_median_allelebalance_allindividuals_alltissues_chrX_unphased_macaques.png", width = 13, height = 6, units = "in", res = 300)
